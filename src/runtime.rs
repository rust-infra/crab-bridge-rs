//! Shared CLI bootstrap and Tokio runtime helpers.
...
/// Load config from env/argv and bootstrap upstream env vars before Clap parsing side effects.
pub fn init() -> Result<()> {
...
/// Run an async CLI handler on a multi-thread Tokio runtime.
