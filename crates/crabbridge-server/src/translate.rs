...
pub fn to_chat_request(
    ...
    let mapped_model = map_model_name(
        &req.model,
        options.provider,
    ...
    ChatRequest {
        ...
        temperature: req
            .temperature
            .or(options.default_temperature.map(f64::from)),
        max_tokens: req.max_output_tokens.or(options.default_max_tokens),
